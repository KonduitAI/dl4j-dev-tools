 ...
 */
public class RnnRandomPipeline implements Pipeline {
    @Override
    ...
    public DataSetIterator getIterator() {
        return new RandomDataSetIterator(100, new long[]{4, 64, 16}, new long[]{4, 10, 16}, RandomDataSetIterator.Values.RANDOM_UNIFORM,
